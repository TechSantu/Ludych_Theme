        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                <div class="accordion modern-faq-accordion" id="lpFAQ">
                    <?php 
                    $faqs = [
                        ['q' => 'What is the average monthly cost in the USA?', 'a' => 'Starting from $1,000 - depending on scope, services, and agency.'],
                        ['q' => 'Which digital marketing services offer the best ROI?', 'a' => 'SEO and content marketing offer high ROI over time. PPC delivers faster but costlier results.'],
                        ['q' => 'Can I hire an agency on a project basis?', 'a' => 'Yes. Project-based pricing is ideal for one-time campaigns, such as product launches or audits.'],
                        ['q' => 'How do I choose the right pricing model?', 'a' => 'Startups often prefer project-based or hybrid retainers. Performance-based works if you need ROI-based accountability.'],
                        ['q' => 'Is digital marketing expensive for small businesses?', 'a' => 'Not if planned well. Start with essentials like SEO and social media. Agencies like Ludych Technology offer entry-level plans.'],
                        ['q' => 'Does pricing vary by industry?', 'a' => 'Yes. Competitive sectors, such as real estate, finance, and e-commerce, often require higher ad spends and technical SEO.'],
                        ['q' => 'How transparent is your pricing?', 'a' => 'Reputed agencies, such as Ludych Technology, share a detailed scope of work, performance KPIs, and monthly reports to ensure clarity.'],
                    ];
