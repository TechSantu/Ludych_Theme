	...
	<div class="custom-container">
		<div class="global-header">
			<?php if ( $industries_heading ) : ?>
				<h2><?php echo esc_html( $industries_heading ); ?></h2>
			<?php endif; ?>
			...
			<div class="min-title">
				...
				<?php if ( $industries_subtitle ) : ?>
					<h6><?php echo esc_html( $industries_subtitle ); ?></h6>
				<?php endif; ?>
			</div>
			
			<?php if ( $industries_title ) : ?>
				<h5><?php echo wp_kses_post( $industries_title ); ?></h5>
			<?php endif; ?>
		</div>
