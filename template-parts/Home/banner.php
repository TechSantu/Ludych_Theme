...
$section_description = get_field('section_description', $post_id);
            ...
            <div class="hero-banner-main">
                <div class="hero-banner-cntn">
                    <div class="small-head">
                        ...
                        <h4><?php echo esc_html($section_text); ?></h4>
                    </div>
                    <h1><?php echo esc_html($section_title); ?></h1>
                    <p><?php echo wp_kses_post($section_description); ?></p>
                    <a href="<?php echo esc_url($section_button['url']); ?>" target="<?php echo esc_attr($section_button['target']); ?>" class="globalBtnDark"><span><?php echo esc_html($section_button['title']); ?> <i class="fa-solid fa-arrow-right-long"></i></span></a>
                </div>
