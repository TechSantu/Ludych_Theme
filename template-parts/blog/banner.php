<?php
/**
 * Blog Banner Template Part
 */

// Determine titles
$main_title = 'Ludych Blog'; // Default
$sub_title  = '';

if ( is_single() ) {
	$main_title = 'Ludych Blog';
	$sub_title  = get_the_title();
} elseif ( is_home() ) {
	// Blog Archive
	$main_title = 'Blog';
	$sub_title  = 'Ludych Blog'; // As per index.html structure
} elseif ( is_archive() ) {
	...
	<div class="custom-container">
		<div class="inner-banner">
			<div class="global-header blogs">
				...
				<?php if ( is_home() ) : ?>
				<h1 class="page-title">Thoughts <span>That Shape</span> the <span>Digital Future</span></h1>
				<p>From emerging tech trends to proven development strategies, our blog explores ideas that 
				shape the future of digital innovation. Learn, grow, and stay inspired with content created 
