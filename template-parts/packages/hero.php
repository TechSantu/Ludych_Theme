...
$hero_title    = ( $acf_ready ? get_field( 'packages_hero_title', $post_id ) : '' ) ?: 'Digital Marketing That Drives Results';
		...
		<div class="inner-banner">
			<div class="global-header service">
				...
				<div class="min-title">
					...
					<h6><?php echo esc_html( $hero_eyebrow ); ?></h6>
				</div>
				...
				<div class="mt-4">
					<a href="<?php echo esc_url( $hero_btn_url ); ?>" class="globalBtnDark">
						<span><?php echo esc_html( $hero_btn_text ); ?> <i class="fa-solid fa-arrow-right-long"></i></span>
					</a>
				</div>
			</div>
		</div>
