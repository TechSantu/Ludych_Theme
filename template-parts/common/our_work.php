...
<section class="work-progress">
	<div class="custom-container">
		<div class="global-header middle-align">
			<h2><?php echo esc_html( $tech_stack_title ); ?></h2>
			<div class="min-title">
				<div class="icon-box">
				...
				<h6><?php echo esc_html( $tech_stack_title ); ?></h6>
			</div>
			<h5><?php echo ( $tech_stack_text ); ?></h5>
		</div>
		<?php
					...
					<div class="list-group" id="list-tab" role="tablist">
						<?php foreach ( $terms as $index => $term ) : ?>
							<a class="list-tab-panel-btn list-tab-panel-btn-action <?php echo 0 === $index ? 'active' : ''; ?>" 
								...
								data-bs-toggle="list" 
								href="#list-<?php echo esc_attr( $term->slug ); ?>" 
								role="tab" 
								aria-controls="list-<?php echo esc_attr( $term->slug ); ?>">
					...
					<div class="tab-content" id="nav-tabContent">
						<?php foreach ( $terms as $index => $term ) : ?>
							<div class="tab-pane fade <?php echo 0 === $index ? 'show active' : ''; ?>" 
								id="list-<?php echo esc_attr( $term->slug ); ?>" 
								role="tabpanel" 
								...
								if ( $tech_query->have_posts() ) :
									...
									echo '<p>No technologies found in this category.</p>';
								endif;
								?>
							</div>
						<?php endforeach; ?>
