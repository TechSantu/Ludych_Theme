				...
				<div class="col-xl-4 col-md-4 col-sm-12">
					<div class="contact-cntn">
						...
						<div class="cntc-box">
							...
							<ul>
								<?php if ( $phone ) : ?>
								<li><span>Phone:</span> <a href="tel:<?php echo esc_attr( str_replace( ' ', '', $phone ) ); ?>"><?php echo esc_html( $phone ); ?></a></li>
								<?php endif; ?>
								<?php if ( $email ) : ?>
						...
						<div class="social-box">
							<ul>
								<?php
								for ( $i = 1; $i <= 5; $i++ ) {
									$s_icon = get_theme_mod( "ludych_footer_social_{$i}_icon" );
									$s_url  = get_theme_mod( "ludych_footer_social_{$i}_url" );
									if ( $s_url && '#' !== $s_url ) {
										echo '<li><a href="' . esc_url( $s_url ) . '" target="_blank"><i class="' . esc_attr( $s_icon ) . '"></i></a></li>';
									}
								}
								?>
							</ul>
